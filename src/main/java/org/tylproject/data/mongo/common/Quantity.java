...
public class Quantity implements Serializable {
    ...
    /*
    * Multiply a Quantity giving a specific unit of measure
    */
    public Quantity multiply(BigDecimal multiplier, String unit) {
        return new Quantity(quantity.multiply(multiplier), unit);
    }
    ...
    /**
     * Divide a Quantity giving a specific unit of measure
     */
    public Quantity divide(BigDecimal divisor, String unit) {
        return new Quantity(quantity.divide(divisor), unit);
    }
